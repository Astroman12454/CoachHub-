  ...
  return (
    <Card className="text-center py-14">
      <CardContent>
        ...
        <h3 className="font-display font-semibold uppercase tracking-tight text-lg text-foreground mb-1.5">{title ?? t("errorState.title")}</h3>
        <p className="text-muted-foreground text-sm max-w-sm mx-auto mb-6">{description ?? t("errorState.description")}</p>
