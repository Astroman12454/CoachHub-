...
const buttonVariants = cva(
  // press-feedback gives every button the same tactile "give" on tap
  // (skipped under prefers-reduced-motion); transition-colors alone read as
  // inert, like a static mockup rather than something you press.
